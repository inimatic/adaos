...
- [Declarative Resource Workbench](declarative-resource-workbench.md): reusable target model for typed resources, queries, operations, workflow-bound actions, evidence, events, observability, Builder inspection, and declarative CRUD-style surfaces
- [Declarative Resource Workbench Roadmap](declarative-resource-workbench-roadmap.md): prioritized delivery plan for Dev Ticket resource proof, Demo Metrics harness, Builder observability, Notebook migration, Media Center selective adoption, Research Workbench adoption, and channel routing
