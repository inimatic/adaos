...
- [Application Access, Permissions, and Roles](application-access-permissions.md): target bridge between Applications and Personalization for Application permission profiles, Application-defined roles, per-user/child/guest access grants, secrets, conversational approvals, Users & Access, and permission observability
- [Application Access, Permissions, and Roles Roadmap](application-access-permissions-roadmap.md): MoSCoW sequence for landing the first enforceable Application permission/role/access slice without turning the MVP into a general IAM platform
