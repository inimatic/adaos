...
| Declarative resource workbench, reusable CRUD-style surfaces, resource operations, query, and Builder resource observability | [Declarative Resource Workbench](declarative-resource-workbench.md), [Web UI Architecture](web-ui-architecture.md), [Operational Event Model](operational-event-model.md) | [Declarative Resource Workbench Roadmap](declarative-resource-workbench-roadmap.md), with Dev Ticket lifecycle dependencies in [Development Signals Roadmap](development-signals-roadmap.md) and Builder integration dependencies in [Builder Roadmap](builder-roadmap.md) | Resource definition/query/operation/event/trace ABI tests; Demo Metrics harness; Dev Ticket resource evidence; Builder Resource Inspector; Notebook, Media Center, and Research Workbench adoption proofs |
