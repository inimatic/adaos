...
| Root MCP and agent-facing governance | [Root MCP Foundation](root-mcp-foundation.md), [SDK Control Plane](../sdk_control_plane.md), [Context Compression](context-compression.md), [Agent And Project Context Capsules](agent-context-capsules.md) | [Root MCP Roadmap](root-mcp-roadmap.md) and the roadmap embedded in [Context Compression](context-compression.md) | MCP contract tests; context attribution receipts; replay and cache-invalidation tests; audit records; Issue Tracker |
