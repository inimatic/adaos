...
| Explainable workflow models, transitions, interactions, and intent mediation | [Explainable Workflow Model and Interaction Architecture](governed-workflow-runtime.md) | [Explainable Workflow Model Roadmap](governed-workflow-runtime-roadmap.md) | Definition validation and transition coverage; explanation/action equivalence; channel evidence; Builder reference run; conditional persistence ADR |
