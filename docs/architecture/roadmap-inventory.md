...
| Explainable workflow models, transitions, interactions, and intent mediation | [Explainable Workflow Model and Interaction Architecture](governed-workflow-runtime.md) | [Explainable Workflow Model Roadmap](governed-workflow-runtime-roadmap.md) | Definition/relationship-plane validation; transition coverage; capability/presentation equivalence; async result/delivery recovery; Builder Project reference run; conditional persistence ADR |
