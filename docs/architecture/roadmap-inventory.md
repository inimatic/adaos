...
| Applications, Catalog, DEV/Trial/prerelease/stable lifecycle, publisher authority, installation/subscriptions, cross-subnet Development Reports | [Application Lifecycle, Distribution, and Feedback](application-lifecycle-and-distribution.md) | [Application Lifecycle and Distribution Roadmap](application-lifecycle-and-distribution-roadmap.md); package mechanics remain in the Artifact Pipeline roadmap, access/permission semantics remain in the Application Access roadmap, and report internals remain in the Development Signals roadmap | Application schema/SDK/MCP tests; Builder chat-to-release proof; Trial/stable activation records; clean-subnet install/update/remove; encrypted report/status round trip |
| Application permission profiles, Application-defined roles, per-user/child/guest Application access grants, Users & Access product surface, secrets/connected-account access, conversational approval entry points, permission observability, and Builder final verification reports | [Application Access, Permissions, and Roles](application-access-permissions.md), with identity facts from [Personalization, Identity, and Access](personalization-identity-access.md) and lifecycle facts from [Application Lifecycle, Distribution, and Feedback](application-lifecycle-and-distribution.md) | [Application Access, Permissions, and Roles Roadmap](application-access-permissions-roadmap.md); Application release lifecycle remains in the Application roadmap and generic profile/device membership remains in the Personalization roadmap | Permission-profile schema tests; policy/effective-decision tests; Applications and Users & Access browser evidence; Builder permission-profiler and final-verification reports; runtime action allow/deny/Pending Action traces; child and guest access proofs |
| Application registry projection, trusted startup snapshots, background manifest validation, permission declaration indexes, component ownership indexes, and federated Application fact indexes | [Application Registry Projection](application-registry-projection.md), with Application lifecycle facts from [Application Lifecycle, Distribution, and Feedback](application-lifecycle-and-distribution.md) and access declaration semantics from [Application Access, Permissions, and Roles](application-access-permissions.md) | [Application Registry Projection](application-registry-projection.md) embeds its roadmap; lifecycle and effective access roadmaps consume its read models without redefining projection trust | Projection schema/query tests; graceful-seal and forced-kill startup tests; manifest validation/quarantine tests; permission/role index tests; Yjs redaction tests; federation fact admission tests; cold-start performance evidence |
| Runtime, skills, scenarios, legacy Projects, presentations/launch targets, package and install lifecycle | [Skill Runtime Lifecycle](../skill_runtime.md), [Skills](../skills.md), [Scenarios](../scenarios.md), [Project Composition, Presentation, and Development Context](project-composition-and-development-context.md), [Artifact Source, Package, and Activation Architecture](artifact-source-package-activation.md) | [Artifact Source, Package, and Activation Roadmap](artifact-source-package-activation-roadmap.md), [Registry, Marketplace, and Operations Roadmap](registry-marketplace-operations-roadmap.md); Application product lifecycle is owned by the Application roadmap | Compatibility/schema tests; lifecycle and operations tests; ProjectRelease/ApplicationRelease and activation records |
| Portable capability and state semantics, implementation and installation bindings, state-space identity and continuity, semantic resolution, transition planning, evidence freshness, and derived evolution graphs | [Capability, Binding, and State Separation](capability-binding-state-separation.md), with package authority from [Artifact Source, Package, and Activation Architecture](artifact-source-package-activation.md) and resource semantics from [Declarative Resource Workbench](declarative-resource-workbench.md) | [Capability, Binding, and State Separation Roadmap](capability-binding-state-separation-roadmap.md); package mechanics remain in the Artifact Pipeline roadmap, Application lifecycle remains in the Application roadmap, and distributed placement/fencing remains in the Distributed Topology roadmap | Contract/schema conformance; immutable resolution and plan records; CRUD rebinding and failure-injection E2E; WorkspaceLock/state-generation evidence; external freshness assessment; domain-capability proof; matched evolutionary benchmark |
| Linear semantic Application creation and evolution across intent, Prototype, capability resolution, packages, Trial/Stable, reusable implementation extraction, Applications observability, and compatibility retirement | The owning architectures listed in [Semantic Application Composition And Evolution Roadmap](application-semantic-composition-roadmap.md); this row introduces no second contract authority | [Semantic Application Composition And Evolution Roadmap](application-semantic-composition-roadmap.md) coordinates the linear gates; every task is implemented and closed in its owning roadmap | One new Application, two installed-Application changes, one independently reused extracted package, exact cross-stage traceability, migration/access/browser evidence, and clean-node recovery |
...
| Cross-domain subnet resource knowledge, source observations, reusable artifacts, optional versions, aliases, i18n, hybrid/latent retrieval, and actionable resource control | [Subnet Knowledge Fabric Target Architecture](subnet-knowledge-fabric.md) | [Subnet Knowledge Fabric Roadmap](subnet-knowledge-fabric-roadmap.md); distributed placement remains in the distributed/artifact roadmaps and domain adoption remains in each product roadmap | Knowledge/SDK schema tests; reconciliation and archive failure injection; multilingual retrieval benchmarks; ACL non-disclosure tests; Media Center and Drive multi-node evidence |
...
| Governed capability development and reproducible Builder evaluation | [AdaOS Builder](builder.md), [Builder Intent-to-Prototype Architecture](builder-intent-to-prototype.md), [Builder E2E Evaluation Pipeline](builder-evaluation-pipeline.md), [Builder Conversational Development](builder-conversational-development.md), [Builder SDK Boundary](builder-sdk-boundary.md), [Project Composition, Presentation, and Development Context](project-composition-and-development-context.md) | [Builder Roadmap](builder-roadmap.md), [Builder Intent-to-Prototype Roadmap](builder-intent-to-prototype-roadmap.md), [Skill Factory](skill-factory.md) | Reviewed Prototype Brief and semantic compiler evidence; declarative E2E suite/run/result records; immutable matched baselines; held-out prompt and compact/wide browser evidence; Builder Development Session/context-scope evidence; isolated DEV runs; Git and publication records |
| Evolution feedback, Development Signals, Dev Tickets, and publisher-local intake of external Application reports | [Development Signals and Evolution Feedback](development-signals.md), [Application Lifecycle, Distribution, and Feedback](application-lifecycle-and-distribution.md), [Governed Evolution](governed-evolution.md) | [Development Signals Roadmap](development-signals-roadmap.md), [Application Lifecycle and Distribution Roadmap](application-lifecycle-and-distribution-roadmap.md), [Governed Evolution Roadmap](governed-evolution-roadmap.md) | Development Signal records; local Dev Tickets; encrypted Development Report envelopes; publisher acceptance; public status stream; BuilderRepair tasks; release and guest-verification evidence |
| Declarative resource workbench, reusable CRUD-style surfaces, resource operations, query, i18n/naming, role/capability access, and Builder resource observability | [Declarative Resource Workbench](declarative-resource-workbench.md), [Web UI Architecture](web-ui-architecture.md), [Operational Event Model](operational-event-model.md), [Personalization, Identity, and Access](personalization-identity-access.md), [Named Entities and Canonical Naming](named-entities.md) | [Declarative Resource Workbench Roadmap](declarative-resource-workbench-roadmap.md), with Dev Ticket lifecycle dependencies in [Development Signals Roadmap](development-signals-roadmap.md) and Builder integration dependencies in [Builder Roadmap](builder-roadmap.md) | Resource definition/query/operation/event/trace ABI tests; locale and access policy tests; Demo Metrics harness; Dev Ticket resource evidence; Builder Resource Inspector; Notebook, Media Center, and Research Workbench adoption proofs |
...
| Agent context control plane, compilation, and Root MCP governance | [Root MCP Foundation](root-mcp-foundation.md), [SDK Control Plane](../sdk_control_plane.md), [Context Resolution, Compilation, And Compression](context-compression.md), [Agent Context Graph And Capsules](agent-context-capsules.md) | [Root MCP Roadmap](root-mcp-roadmap.md) owns the adapter; the roadmap embedded in [Context Resolution, Compilation, And Compression](context-compression.md) owns registry/resolver/compiler/curator sequencing; domain adoption remains in its owning roadmap | Schema/SDK/MCP contract tests; context plans and attribution receipts; trust/taint and promotion tests; replay, `as_of`, cache-invalidation, and matched-budget context evaluation; audit records; Issue Tracker |
...
| Personalization, identity, local access facts, devices, sessions, and privacy | [Personalization, Identity, and Access](personalization-identity-access.md), [Device Access and Browsers](device-access-and-browsers.md); Application-specific permission and role semantics are owned by [Application Access, Permissions, and Roles](application-access-permissions.md) | [Personalization Roadmap](personalization-identity-access-roadmap.md), [Device Access Roadmap](device-access-roadmap.md); Application access sequencing remains in the Application Access roadmap | Phase acceptance docs; policy and API tests; audit evidence |
...
| Browser UI, universal Client component system, webspaces, and semantic addressing | [Web UI Architecture](web-ui-architecture.md), [UI Addressing](ui-addressing.md) | [Client Component System Roadmap](client-component-system-roadmap.md), [Webspace Scenario Pointer/Projection Roadmap](webspace-scenario-pointer-projection-roadmap.md), [Webspace Evolution Roadmap](webspace-evolution-roadmap.md) | Generated component registry and ABI impact reports; Client conformance tests; structured UI runtime diagnostics; EN/RU compact/wide browser E2E evidence |
...
| CR 1.0 cross-cutting performance, resource, recovery, security, compatibility, and operability gates | Existing domain architectures remain authoritative | [CR 1.0 Non-Functional Readiness Roadmap](cr1-non-functional-readiness-roadmap.md) | Versioned workload fixtures; local/routed benchmarks; soak and failure injection; clean/upgraded-node qualification; security and migration evidence |
| Legacy operator-surface retirement | [Infrascope Retirement Architecture](infrascope.md), [AdaOS Product Terminology](product-terminology.md) | [Infrascope Retirement Roadmap](infrascope-roadmap.md) | Zero-use telemetry; neutral-contract tests; local/routed browser qualification |
...
3. Use the Semantic Application Composition roadmap only to order the
   cross-domain creation/evolution gates. Put every implementation task and
   closure decision in its owning domain roadmap and reference it rather than
   cloning it.
4. Put other cross-domain evolution outcomes in the Governed Evolution Roadmap
   only when they are milestones or proof gates, not merely large technical
   tasks.
5. Put a concrete defect, request, investigation, or implementation run in the
   Issue Tracker and link it back to the owning roadmap item.
6. Put transient progress in the issue or automation record. Do not copy it to
   architecture pages.
7. Put test output, stand observations, publication records, migration reports,
...
- Observability spans Incident Registry, Runtime Guarding, Root diagnostics,
  resource workbench inspection, and post-deploy testing. Resource-level query,
  operation, event, render, and evidence traces are owned by
  [Declarative Resource Workbench](declarative-resource-workbench.md). A broader
  runtime observability contract is still needed to define shared signal and
  evidence boundaries across non-resource diagnostics.
