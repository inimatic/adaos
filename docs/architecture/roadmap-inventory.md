...
| Governed research, experiment tracking, execution providers, and scientific evidence | [AdaOS Research Fabric](research-fabric.md) | [Research Fabric Roadmap](research-fabric-roadmap.md) | Research contract/workflow tests; storage, tracker, and executor conformance; locked TLP protocol and paired trials; portable evidence bundle; independent analysis recomputation; second-domain proof before core promotion |
