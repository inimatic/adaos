...
| Governed workflows, interactions, intent mediation, and durable execution | [Governed Workflow and Interaction Runtime](governed-workflow-runtime.md) | [Governed Workflow Runtime Roadmap](governed-workflow-runtime-roadmap.md) | Workflow conformance/fault tests; interaction channel evidence; provider ADR; Builder reference run |
