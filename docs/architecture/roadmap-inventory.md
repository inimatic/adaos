...
| Governed and autonomous research, experiment tracking, execution providers, scientific releases, and replication evaluation | [AdaOS Research Fabric](research-fabric.md), [Research Fabric Core Readiness](research-fabric-core-readiness.md) | [Research Fabric Roadmap](research-fabric-roadmap.md) | Research contract/workflow tests; storage, tracker, and executor conformance; deterministic and autonomous TLP proofs; Builder source-to-project lineage; mandate/budget and evidence gates; independently verified ResearchRelease; frozen replication benchmark and matched baselines before cross-domain/core claims |
