...
| Personalization, identity, local access facts, devices, sessions, privacy zones, and audit | [Personalization, Identity, and Access](architecture/personalization-identity-access.md) and its roadmap |
...
| Application permission profiles, Application roles, per-user/child/guest Application grants, Users & Access, secrets/connected-account access, approval observability, and Builder final verification | [Application Access, Permissions, and Roles](architecture/application-access-permissions.md) and its roadmap |
