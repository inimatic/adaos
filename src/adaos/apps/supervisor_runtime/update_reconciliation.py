...
class UpdateReconciliationService:
    ...
    def public_payload(
        ...
        public_status = {
            ...
            "prepare_timeout_sec": status.get("prepare_timeout_sec"),
            "prepare_elapsed_s": status.get("prepare_elapsed_s"),
            "prepare_heartbeat_at": status.get("prepare_heartbeat_at"),
            "prepare_timed_out": bool(status.get("prepare_timed_out")),
            "prepare_stage": str(status.get("prepare_stage") or "").strip() or None,
            "prepare_stage_message": str(status.get("prepare_stage_message") or "").strip() or None,
            "prepare_progress_at": status.get("prepare_progress_at"),
        ...
        return {
            ...
            "attempt": {
                ...
                "prepare_timeout_sec": attempt.get("prepare_timeout_sec"),
