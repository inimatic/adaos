...
_AUTOSTART_PASSTHROUGH_ENV_KEYS = (
    ...
    "ADAOS_CORE_UPDATE_SOURCE_MODE",
    "ADAOS_CORE_UPDATE_SOURCE_ARCHIVE_URL",
    "ADAOS_CORE_UPDATE_SOURCE_ARCHIVE_URL_TEMPLATE",
    "ADAOS_CORE_UPDATE_SOURCE_ARCHIVE_SHA256",
    "ADAOS_CORE_UPDATE_ARCHIVE_URL",
    "ADAOS_CORE_UPDATE_ARCHIVE_URL_TEMPLATE",
    "ADAOS_CORE_UPDATE_ARCHIVE_SHA256",
    "ADAOS_CORE_UPDATE_ARCHIVE_AUTHORIZATION",
    "ADAOS_CORE_UPDATE_ARCHIVE_TOKEN",
    "ADAOS_CORE_UPDATE_REPO_URL",
    ...
    "ADAOS_REALTIME_ROUTE_HANDSHAKE_TIMEOUT_S",
