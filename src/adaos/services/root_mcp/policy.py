...
def list_capability_classes() -> list[dict[str, Any]]:
    return [
        ...
        _capability_entry(
            ...
            surface="operations",
            risk="high",
            summary="Redeem a targeted Trial capability and create its exact reviewed install plan.",
            default_grants=["owner_token"],
        ),
        _capability_entry(
            ...
            surface="operations",
            risk="medium",
            summary="Read publisher-local Development Report intake and quarantine metadata.",
            default_grants=["owner_token"],
        ),
        _capability_entry(
            "applications.report",
        ...
        _capability_entry(
            ...
            surface="development",
            risk="high",
            summary="Create and materialize Application source, DEV Preview, and immutable Trials through Builder.",
            default_grants=["owner_token"],
        ),
        _capability_entry(
            ...
            surface="development",
            risk="high",
            summary="Publish accepted Trials and promote exact Application release digests.",
            default_grants=["owner_token"],
        ),
        _capability_entry(
        ...
        _capability_entry(
            ...
            surface="development",
            risk="medium",
            summary="Resolve screenshots and evidence artifacts attached to Dev Tickets.",
            default_grants=["owner_token"],
        ),
        _capability_entry(
            ...
            surface="development",
            risk="medium",
            summary="Create, claim, comment, and advance governed Dev Ticket lifecycles.",
            default_grants=["owner_token"],
        ),
        _capability_entry(
        ...
        _capability_entry(
            ...
            surface="development",
            risk="low",
            summary="Resolve, plan, compile, and inspect governed AdaOS context projections.",
            default_grants=["owner_token", "bearer"],
        ),
        _capability_entry(
            ...
            surface="development",
            risk="low",
            summary="Record immutable context attribution and usage receipts.",
            default_grants=["owner_token"],
        ),
        _capability_entry(
            ...
            surface="development",
            risk="medium",
            summary="Propose episodic or reusable memory candidates without promotion authority.",
            default_grants=["owner_token"],
        ),
        _capability_entry(
            "skill_factory.read.status",
            surface="development",
            risk="low",
            summary="Read Skill Factory queue, forge policy, and dev-node status diagnostics.",
            default_grants=["owner_token", "bearer"],
        ),
        _capability_entry(
            ...
            surface="development",
            risk="medium",
            summary="Submit normalized Builder realize requests into the Root development queue.",
            default_grants=["owner_token"],
        ),
        _capability_entry(
        ...
        _capability_entry(
            ...
            surface="development",
            risk="medium",
            summary="Report liveness and status from an isolated development node.",
            default_grants=["owner_token"],
        ),
        _capability_entry(
            ...
            surface="development",
            risk="medium",
            summary="Poll Root for Skill Factory task assignment.",
            default_grants=["owner_token"],
        ),
        _capability_entry(
            ...
            surface="development",
            risk="high",
            summary="Report Skill Factory task progress, completion, or failure results.",
            default_grants=["owner_token"],
        ),
        _capability_entry(
            "skill_factory.dev_task.cancel",
            surface="development",
            risk="medium",
            summary="Cancel a queued or active Skill Factory development task.",
            default_grants=["owner_token"],
        ),
        _capability_entry(
