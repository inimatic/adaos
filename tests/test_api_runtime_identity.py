...
@pytest.mark.parametrize(
    "tool_id",
    ["development.search_descriptors", "development.get_descriptor_item"],
)
def test_admin_root_mcp_call_allows_read_only_descriptor_tools(monkeypatch, tool_id) -> None:
    calls: list[dict[str, object]] = []
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("applications.list_components", "applications.read"),
        ("applications.list_placements", "applications.read"),
        ("applications.assess_updates", "applications.read"),
        ("applications.plan_updates", "applications.plan"),
        ("applications.get_update_batch", "applications.read"),
        ("applications.apply_updates", "applications.apply"),
        ...
        ("applications.access.privacy", "applications.read"),
        ("applications.access.simulate", "applications.read"),
        ("applications.access.grant", "applications.apply"),
        ("applications.access.change", "applications.apply"),
        ("applications.access.revoke", "applications.apply"),
        ("applications.access.export", "applications.read"),
        ("applications.access.import", "applications.apply"),
        ("applications.access.connected_account", "applications.apply"),
        ("applications.access.update_review", "applications.read"),
        ("applications.access.profile", "applications.read"),
        ("applications.access.verify_release", "applications.plan"),
        ("applications.list_releases", "applications.read"),
        ("applications.list_operations", "applications.read"),
        ("applications.setup.show", "applications.read"),
        ("applications.setup.configure", "applications.apply"),
        ...
        ("applications.development.materialize", "applications.develop"),
        ("applications.development.preview", "applications.develop"),
        ("applications.development.create_trial", "applications.develop"),
        ("applications.development.decide_trial", "applications.develop"),
        ("applications.development.publish_link_trial", "applications.publish"),
        ("applications.development.publish_prerelease", "applications.publish"),
        ("applications.development.promote_stable", "applications.publish"),
        ("applications.development.publish_to_registry", "applications.publish"),
        ("applications.development.publish_stable_source", "applications.publish"),
